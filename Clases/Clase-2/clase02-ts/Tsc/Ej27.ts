...
como lo indique ahi
*/
function CrearSelect(cadena:string):void
{
 //1-Crear el elemento "select" y los "options"
 var elemento=document.createElement("select");
 var arrayOptions=[];

 for(let i=0;i<parseInt(cadena);i++)
 {
     //creo los options
     var opcion:any =document.createElement("option");
 ...
 const part1 = document.getElementById("div");
 if(part1)
 {
     part1.appendChild(elemento);
 }
...
*/
function CrearSelect2(cadena:string):void
{
 ...
 else
 {
    ...
    //dentro de la option guardamos lo que escribimos en el cuadro de texto 
     ...
     const part1:any=document.getElementById("select1");
     if(part1)
     {
         part1.add(opcion);
     }
